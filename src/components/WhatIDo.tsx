        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building scalable and responsive web applications using the MERN
                stack. Expert in RESTful APIs and modern frontend frameworks.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Integrating AI models for real-time applications and managing
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">MediaPipe AI</div>
                <div className="what-tags">Python</div>
                <div className="what-tags">C++ / Java</div>
                <div className="what-tags">Web Security</div>
